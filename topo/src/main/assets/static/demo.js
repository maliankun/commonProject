...
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });
    ...
    createNetworkToolbar2: function (network, callback) {
        var toolbar = document.createElement('div');
        //toolbar.style.background = twaver.Colors.blue_light;
//        demo.Util.addButton(toolbar, 'Default', 'select', function () {
//            if (twaver.Util.isTouchable) {
//                network.setTouchInteractions();
//            } else {
...
//        });
//        demo.Util.addButton(toolbar, 'Pan', 'pan', function () { network.setPanInteractions(); });
        demo.Util.addButton(toolbar, 'Back', '../images/toolbar/smallback.png', callback );
        demo.Util.addButton(toolbar, 'Zoom In', 'zoomIn', function () { network.zoomIn(); });
        demo.Util.addButton(toolbar, 'Zoom Out', 'zoomOut', function () { network.zoomOut(); });
        demo.Util.addButton(toolbar, 'Zoom Reset', 'zoomReset', function () { network.zoomReset(); });
        demo.Util.addButton(toolbar, 'Zoom Overview', 'zoomOverview', function () { network.zoomOverview(); });
...
//        });
    ...
    createNetworkToolbar3: function (network, callback) {
        var toolbar = document.createElement('div');
        //demo.Util.addButton(toolbar, 'Back', 'file:///android_asset/static/images/toolbar/back.png', callback );
        //demo.Util.addButton(toolbar, 'Zoom In', 'file:///android_asset/static/images/toolbar/zoomInBig.png', function () { network.zoomIn(); });
        //demo.Util.addButton(toolbar, 'Zoom Out', 'file:///android_asset/static/images/toolbar/zoomOutBig.png', function () { network.zoomOut(); });
        //demo.Util.addButton(toolbar, 'Zoom Reset', 'file:///android_asset/static/images/toolbar/zoomBig.png', function () { network.zoomReset(); });
        //demo.Util.addButton(toolbar, 'Zoom Overview', 'file:///android_asset/static/images/toolbar/zoomBig.png', function () { network.zoomOverview(); });
        
        /*if (demo.Util.isFullScreenSupported()) {
            demo.Util.addButton(toolbar, 'Full screen', '../images/toolbar/zomm.png', function () {
                demo.Util.toggleFullscreen();
            });
        }*/
        return toolbar;
    ...
    addButton2: function (div, name, src, callback) {
        var button = document.createElement('input');
    ...
    addInputNoLabel: function (div, value, name, callback) {
        var input = document.createElement('input');
        input.id = name;
        input.value = value;
        input.addEventListener('keydown', function (e) {
...
//        div.appendChild(label);
    ...
    addInputNoLabel2: function (div, value, name, callback) {
        var input = document.createElement('input');
