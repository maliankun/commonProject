var images ={
    registImages:function(commonnetwork){
        Util.registerNormalImage(TopoImages.ROOT, 'ROOT', commonnetwork);
        Util.registerNormalImage(TopoImages.OTN, 'OTN', commonnetwork);
        Util.registerNormalImage(TopoImages.SDH, 'SDH', commonnetwork);
        Util.registerNormalImage(TopoImages.WDM, 'WDM', commonnetwork);
        Util.registerNormalImage(TopoImages.PTN, 'PTN', commonnetwork);
        Util.registerNormalImage(TopoImages.PTN30, 'PTN30', commonnetwork);
        Util.registerNormalImage(TopoImages.PTN35, 'PTN35', commonnetwork);
        Util.registerNormalImage(TopoImages.PTN40, 'PTN40', commonnetwork);
        Util.registerNormalImage(TopoImages.PTN45, 'PTN45', commonnetwork);
        Util.registerNormalImage(TopoImages.PTNBIG, 'PTNBIG', commonnetwork);
        Util.registerNormalImage(TopoImages.PTNSMALL, 'PTNSMALL', commonnetwork);
        Util.registerNormalImage(TopoImages.SDHBIG, 'SDHBIG', commonnetwork);
        Util.registerNormalImage(TopoImages.SDHSMALL, 'SDHSMALL', commonnetwork);
        Util.registerNormalImage(TopoImages.OTNBIG, 'OTNBIG', commonnetwork);
        Util.registerNormalImage(TopoImages.OTNSMALL, 'OTNSMALL', commonnetwork);
        Util.registerNormalImage(TopoImages.ADM, 'ADM', commonnetwork);
        Util.registerNormalImage(TopoImages.MADM, 'MADM', commonnetwork);
        //Util.registerNormalImage(TopoImages.OPENINTREE, 'OPENINTREE', main.tree);
        //Util.registerNormalImage(TopoImages.CLOSEINTREE, 'CLOSEINTREE', main.tree);
        //Util.registerNormalImage(TopoImages.GROUPOPEN, 'GROUPOPEN', main.tree);
        //Util.registerNormalImage(TopoImages.GROUPCLOSE, 'GROUPCLOSE', main.tree);
        Util.registerNormalImage(TopoImages.NETWORKBG, 'NETWORKBG', commonnetwork);
        Util.registerNormalImage(TopoImages.FILE, 'file', commonnetwork);
        Util.registerNormalImage(TopoImages.SUBNET, 'SUBNET', commonnetwork);
        Util.registerNormalImage(TopoImages.VENDOR, 'vendor', commonnetwork);
        Util.registerNormalImage(TopoImages.OSN8800, 'OSN8800', commonnetwork);
        Util.registerNormalImage(TopoImages.OSN880032, 'OSN880032', commonnetwork);
        Util.registerNormalImage(TopoImages.FONST5000, 'FONST5000', commonnetwork);
        Util.registerNormalImage(TopoImages.FONST3000, 'FONST3000', commonnetwork);
        Util.registerNormalImage(TopoImages.FONST6000U30, 'FONST6000U30', commonnetwork);
        Util.registerNormalImage(TopoImages.FONST6000U60A, 'FONST6000U60A', commonnetwork);
        Util.registerNormalImage(TopoImages.WDMOA, 'WDMOA', commonnetwork);
        Util.registerNormalImage(TopoImages.WDMOMT, 'WDMOMT', commonnetwork);
        Util.registerNormalImage(TopoImages.FONSTCOTP2, 'FONSTCOTP2', commonnetwork);
        Util.registerNormalImage(TopoImages.OADM, 'OADM', commonnetwork);
        Util.registerNormalImage(TopoImages.OLA, 'OLA', commonnetwork);
        Util.registerNormalImage(TopoImages.OTM, 'OTM', commonnetwork);
        Util.registerNormalImage(TopoImages.VNE, 'VNE', commonnetwork);
        Util.registerNormalImage(TopoImages.EMS, 'ems', commonnetwork);
        // Util.registerNormalImage('../images/topo/OTN.png', 'OTN', main.tree);
        // Util.registerNormalImage('../images/topo/SDH.png', 'SDH', main.tree);
        // Util.registerNormalImage('../images/topo/WDM.png', 'WDM', main.tree);
        // Util.registerNormalImage('../images/topo/PTN.png', 'PTN', main.tree);
        // Util.registerNormalImage('../images/topo/ADM.png', 'ADM', main.tree);
        // Util.registerNormalImage('../images/topo/MADM.png', 'MADM', main.tree);

        var icon_scale=1.3;
        //twaver.Util.registerImageByUrl('../../image/ROOT.png','cloud3',this.network);
        ...
        twaver.Util.registerImage('cloud2', {
            "w": 64,
            "h": 44,
            "origin": {
                "x": 0,
    ...
    setImages:function(node){
        if (node.getClient("ne_model") == "2") {
            node.setImage("VNE");
            // 160X10G WDM OA
        } else if (node.getClient("ne_model") == "4") {
            node.setImage("WDMOA");
        //     FONST6000 U60A
        } else if (node.getClient("ne_model") == "5") {
            node.setImage("FONST6000U60A");
        } else if (node.getClient("ne_model") == "9") {
            node.setImage("FONST5000");
        } else if (node.getClient("ne_model") == "69372938") {
            node.setImage("OADM");
            // FONST 3000
        } else if (node.getClient("ne_model") == "7") {
            node.setImage("FONST3000");
        //     FONST6000 U30
        } else if (node.getClient("ne_model") == "3") {
            node.setImage("FONST6000U30");
        } else if (node.getClient("ne_model") == "131168604") {
            node.setImage("OSN8800");
        } else if (node.getClient("ne_model") == "1") {
            node.setImage("OSN880032");
            // 160X10G WDM OMT
        } else if (node.getClient("ne_model") == "6") {
            node.setImage("WDMOMT");
        //     FONST COTP-2
        } else if (node.getClient("ne_model") == "8") {
            node.setImage("FONSTCOTP2");
        } else if (node.getClient("ne_model") == "69372927") {
            node.setImage("OTM");
        } else if (node.getClient("ne_model") == "69372930") {
            node.setImage("OLA");
        // } else if (node.getClient("ne_model") == "") {
        //     node.setImage("");
        } else if (node.getClient("equ_type") == "11") {
            node.setImage("OTN");
        } else if (node.getClient("equ_type") == "1") {
            node.setImage("SDH");
        } else if (node.getClient("equ_type") == "3") {
            node.setImage("WDM");
        } else if (node.getClient("equ_type") == "8") {
            node.setImage("PTN");
        }
    }
}