...
public class AppConfig {
    ...
    public static String TOPO_ROUTE_URL = "http://218.207.69.236:6105";
...
//    public static String TOPO_ROUTE_URL = "http://10.110.2.60:8787";
    ...
    public static class Urls {
        ...
        public static final String URL_GET_TOPO_LIST_SUBNET = "/wx_topo/newTopoRouteController/queryTopoAndRouteBySubnet";//根据子网
        public static final String URL_GET_TOPO_LIST_IDS = "/wx_topo/newTopoRouteController/queryTopoListByIds";//根据拓扑连接id
        public static final String URL_GET_TOPO_LIST_NE = "/wx_topo/newTopoRouteController/queryTopoListByNe";
//        wx_topo/newTopoRouteController/topoRoute
        public static final String URL_GET_TOPPO_ROUTE_BY_TOPO_ID = "/wx_topo/newTopoRouteController/topoRoute";//根据拓扑连接id，查询可用拓扑路由
        ...
        public static final String URL_GET_TOPO_LAY_SEG = "/wx_topo/newTopoRouteController/topoLayseg";//根据光缆段id查询敷设段空间数据
        public static final String URL_GET_TOPO_ROUTE_BIND_OLP_TOPO_ID = "/wx_topo/newTopoRouteController/queryCheckedRoute4OLP";//OLP查询拓扑路由绑定数据
        public static final String URL_GET_OLP_DEVICE_CARD = "/wx_topo/newTopoRouteController/queryEndInfoByOLPCard";//查询OLP板卡对端设备与板卡
        ...
        public static final String URL_ONLY_ROUTE_SEARCH = "/wx_topo/topoRouteController/queryCheckedRouteByOnlyNe";//查询单个网元
        public static final String URL_GET_SUBNET_BY_ELEMENT = "/devicetopo/api/v1/topoManager/getSubnetByelement";//查询AZ两端子网
