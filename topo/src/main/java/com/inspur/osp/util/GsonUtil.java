...
public class GsonUtil {
  ...
  /** 
    ...
    * @return
    */
   public static JsonObject strTojsonobj(String gsonString){
	   JsonParser parser = new JsonParser();   
	   JsonObject Jobj = parser.parse(gsonString).getAsJsonObject();
	   return Jobj;
   }
   ...
   public static <T> List<T> GsonToList(String gsonString, Class<T[]> clazz) {
           T[] arr = new Gson().fromJson(gsonString, clazz);
